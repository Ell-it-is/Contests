...
#defien DI <double, int>
#defien SD <string, double>
#defien DS <double, string>
...
#defien PDI pair<double, int>
#defien PSD pair<string, double>
#defien PDS pair<double, string>
