...
int Solve() {
  ...
  Print(min(Size(ans), k));
  Repeat (min(Size(ans), k)) {
    cout << ans[i] << " ";
  }
  cout << "\n";
...
/* ================= Notes ================== //
    k = 4
    2 3 3 1 1 2 1 2 3 3 5 7
    2 3 1 5
    3 1 5 7

    Last k of unique numbers (without changing order) and reverse
