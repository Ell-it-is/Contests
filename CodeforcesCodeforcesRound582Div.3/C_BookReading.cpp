...
int Solve() {
  ...
  llong t = divisors / (d - 1);
  ans *= t;
  
  llong r = divisors % (d - 1);
  Repeat (r) {
    llong num = pos * m;
    ans += num % 10;
  }
...
/* ================= Notes ================== //
   The sum of last digits of all numbers 1 to 'n'
   With the condition that the number is divisible by 'm'

   I know how many such numbers there are -> n / m
