// time-limit: 2000
// problem-url: https://codeforces.com/contest/1203/problem/C
...
/* ================= Notes ================== //
   # of values x for which:
   for each i [1...n] it is true that:
   a[i] % x == 0
*/
